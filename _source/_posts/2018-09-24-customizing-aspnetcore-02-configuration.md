...
To learn more about ASP.NET Core Dependency Injection have a look into the next part of the series: [Customizing ASP.NET Core Part 03: Dependency Injection]({% post_url customizing-aspnetcore-02-dependency-injection.md %})
