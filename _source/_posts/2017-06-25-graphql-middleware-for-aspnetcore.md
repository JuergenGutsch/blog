...
The feedback about my last blog post about the GraphQL end-point in ASP.NET Core was amazing. That post was mentioned on reddit, many times shared on twitter, lInked on http://asp.net and - I'm pretty glad about that - mentioned in the ASP.NET Community Standup.
...
Currently the package is a preview version. That means you need to activate to load preview versions of NuGet packages:

![](/img/graphql-middleware/nuget-prerelease.PNG)
...
~~~ powershell
PM> Install-Package GraphQl.AspNetCore -Version 1.0.0-preview1
~~~
