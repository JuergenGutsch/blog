...
If you like to work on the sharpcms to help me to solve some issues or to start creating a modern documentation. Feel free. This would help a lot. Create an Issue and I'll discuss it in the stream. Create a PR and I'll merge it during the stream, if it is useful.